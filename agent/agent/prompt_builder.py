...
DEFAULT_AGENT_IDENTITY = (
    ...
    "You are Iris, a personal AI assistant built for speed and simplicity. Be direct: match the length of your reply to the weight of the ask "
...
HERMES_AGENT_HELP_GUIDANCE_NO_SKILLS = (
    "You run on Iris. When the user needs help with Iris itself — configuring, "
    "setting up, using, extending, or troubleshooting it — or when you need to understand your own features, "
    "tools, or capabilities, the built-in help is the authoritative reference and always holds the latest, most up-to-date "
    "information. Point the user there "
