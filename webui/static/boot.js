...
(function(){
  ...
  // Prefer Iris server-side STT (MediaRecorder -> /api/transcribe) only
...
$('modelSelect').onchange=async()=>{
  ...
  // Warn if selected model belongs to a different provider than what Iris is configured for
...
(async()=>{
  ...
  try{
    ...
    window._botName=s.bot_name||'Iris';
